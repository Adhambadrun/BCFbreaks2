...
| Branding | Official `/public/logo.png` on the browser tab (`metadata.icons`: icon/shortcut/apple), the nav bar and every access-verification gate (`AccessGate` — never a generic warning shield). |
